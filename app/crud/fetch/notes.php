      ...
      if(res.success){
        let html = `
          ...
          <div class="grid grid-cols-2 gap-6 bg-white dark:bg-gray-800 p-6 rounded shadow">
            <p class="text-gray-700 dark:text-gray-200"><strong>id:</strong> ${res.data.id}</p><p class="text-gray-700 dark:text-gray-200"><strong>title:</strong> ${res.data.title}</p><p class="text-gray-700 dark:text-gray-200"><strong>content:</strong> ${res.data.content}</p><p class="text-gray-700 dark:text-gray-200"><strong>updated_at:</strong> ${res.data.updated_at}</p><p class="text-gray-700 dark:text-gray-200"><strong>created_at:</strong> ${res.data.created_at}</p><p class="text-gray-700 dark:text-gray-200"><strong>status:</strong> ${res.data.status}</p>
              ...
              if(res.success){
                  ...
                  res.data.forEach(notes => {
                      html += `<div class="bg-white dark:bg-gray-800 p-4 rounded shadow mb-4">
                                  <p>id: ${notes.id}</p><p>title: ${notes.title}</p><p>content: ${notes.content}</p><p>updated_at: ${notes.updated_at}</p><p>created_at: ${notes.created_at}</p><p>status: ${notes.status}</p>
                                </div>`;
                  });
...
const excluded = ['id', 'title', 'content', 'updated_at', 'created_at', 'status'];
