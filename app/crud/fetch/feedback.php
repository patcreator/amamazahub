        ...
        <div class="p-4">
          ...
          <div class="mt-4">
            ...
            >
              ...
              <p><?= htmlspecialchars($item['updated_at'] ?? '') ?></p>
            </div>
          </div>
        </div>
      </div>
      ...
      if(res.success){
        let html = `
          ...
          <div class="grid grid-cols-2 gap-6 bg-white dark:bg-gray-800 p-6 rounded shadow">
            <p class="text-gray-700 dark:text-gray-200"><strong>id:</strong> ${res.data.id}</p><p class="text-gray-700 dark:text-gray-200"><strong>user_id:</strong> ${res.data.user_id}</p><p class="text-gray-700 dark:text-gray-200"><strong>name:</strong> ${res.data.name}</p><p class="text-gray-700 dark:text-gray-200"><strong>email:</strong> ${res.data.email}</p><p class="text-gray-700 dark:text-gray-200"><strong>subject:</strong> ${res.data.subject}</p><p class="text-gray-700 dark:text-gray-200"><strong>message:</strong> ${res.data.message}</p><p class="text-gray-700 dark:text-gray-200"><strong>rating:</strong> ${res.data.rating}</p><p class="text-gray-700 dark:text-gray-200"><strong>type:</strong> ${res.data.type}</p><p class="text-gray-700 dark:text-gray-200"><strong>status:</strong> ${res.data.status}</p><p class="text-gray-700 dark:text-gray-200"><strong>created_at:</strong> ${res.data.created_at}</p><p class="text-gray-700 dark:text-gray-200"><strong>updated_at:</strong> ${res.data.updated_at}</p>
              ...
              if(res.success){
                  ...
                  res.data.forEach(feedback => {
                      html += `<div class="bg-white dark:bg-gray-800 p-4 rounded shadow mb-4">
                                  <p>id: ${feedback.id}</p><p>user_id: ${feedback.user_id}</p><p>name: ${feedback.name}</p><p>email: ${feedback.email}</p><p>subject: ${feedback.subject}</p><p>message: ${feedback.message}</p><p>rating: ${feedback.rating}</p><p>type: ${feedback.type}</p><p>status: ${feedback.status}</p><p>created_at: ${feedback.created_at}</p><p>updated_at: ${feedback.updated_at}</p>
                                </div>`;
                  });
...
const excluded = ['id', 'user_id', 'name', 'email', 'subject', 'message', 'rating', 'type', 'status', 'created_at', 'updated_at'];
