      ...
      if(res.success){
        let html = `
          ...
          <div class="grid grid-cols-2 gap-6 bg-white dark:bg-gray-800 p-6 rounded shadow">
            <p class="text-gray-700 dark:text-gray-200"><strong>id:</strong> ${res.data.id}</p><p class="text-gray-700 dark:text-gray-200"><strong>name:</strong> ${res.data.name}</p><p class="text-gray-700 dark:text-gray-200"><strong>value:</strong> ${res.data.value}</p><p class="text-gray-700 dark:text-gray-200"><strong>type:</strong> ${res.data.type}</p><p class="text-gray-700 dark:text-gray-200"><strong>updated_at:</strong> ${res.data.updated_at}</p><p class="text-gray-700 dark:text-gray-200"><strong>created_at:</strong> ${res.data.created_at}</p><p class="text-gray-700 dark:text-gray-200"><strong>status:</strong> ${res.data.status}</p>
              ...
              if(res.success){
                  ...
                  res.data.forEach(settings => {
                      html += `<div class="bg-white dark:bg-gray-800 p-4 rounded shadow mb-4">
                                  <p>id: ${settings.id}</p><p>name: ${settings.name}</p><p>value: ${settings.value}</p><p>type: ${settings.type}</p><p>updated_at: ${settings.updated_at}</p><p>created_at: ${settings.created_at}</p><p>status: ${settings.status}</p>
                                </div>`;
                  });
...
const excluded = ['id', 'name', 'value', 'type', 'updated_at', 'created_at', 'status'];
